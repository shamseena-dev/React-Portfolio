  ...
  return (
   ...
   <p>
    Talking a bit about my background, I graduated in Computer Science & Engineering (B.Tech) and grabbed my first job offer in hand while still in 6th semester. It was a dream come true as I joined Tata Consultancy Services within 2 weeks of completion my college days.  
        I worked for 2+ years as Systems Engineer at T.C.S(Bangalore) where I handled Level-2 tech support for SAP ERP, EMEA region.  After this, I earned a couple of project experience in UX/UI Manual Testing
        for a start up and WordPress Content Management for an N.G.O .
        </p>
  <p>
        I have always been passionate to dive into the Development field. I have been learning Web development from multiple sources for a while and recently got graduated in Web Development from ZTM academy . I have built a couple of personal projects and have volunteered for corona-help.org as Frontend Developer.
